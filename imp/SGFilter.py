...
from scipy.signal import _arraytools
...
def _fit_edge(x, window_start, window_stop, interp_start, interp_stop,
    ...
    x_edge = _arraytools.axis_slice(x, start=window_start, stop=window_stop, axis=axis)
    ...
    y_edge = _arraytools.axis_slice(y, start=interp_start, stop=interp_stop, axis=axis)
    y_edge[...] = values
